...
import type { RssConnectorResult, RssConnectorErrorCode } from './complianceRssConnector.js'
import { compareSourcesForMonitoring } from './complianceSourceGovernance.js'
import {
...
} from './watchtowerIngestionRun.js'
// TYPE-ONLY, and that is load-bearing. A value import pulls
// complianceRepository -> supabase.ts, whose module body reads
// `import.meta.env.VITE_*`. That is undefined under Node ESM, so any Vercel
// Function importing this module would die at load. The browser wiring that
// needs the real repository lives in watchtowerIngestionBrowserDeps.ts.
import type * as repo from './complianceRepository.js'
