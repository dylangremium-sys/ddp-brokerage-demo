...
import { NEEDS_NATIVE_REVIEW, PENDING_SECTIONS } from '../pages/public/thaiSupplierCopy'
...
describe('the page carries the existing Thai, not a retyped version of it', () => {
  ...
  it('uses the existing Thai for what happens after applying', () => {
    expect(body()).toContain(T.th.farmerRegReviewNote)
