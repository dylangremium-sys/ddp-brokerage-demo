...
export const T = {
  en: {
    ...
    corpPrivacyCookiesText: 'This site runs no third-party analytics, advertising or tracking scripts — its content security policy permits the browser to load code only from this site itself and to talk only to our own backend. Browser storage is used for the two things the site needs to work: keeping you signed in, and remembering whether you chose English or Thai.',
  ...
  th: {
    ...
    corpPrivacyCookiesText: 'เว็บไซต์นี้ไม่ใช้สคริปต์วิเคราะห์ข้อมูล โฆษณา หรือการติดตามจากบุคคลที่สาม นโยบายความปลอดภัยของเนื้อหาอนุญาตให้เบราว์เซอร์โหลดโค้ดจากเว็บไซต์นี้เท่านั้น และเชื่อมต่อกับระบบหลังบ้านของเราเท่านั้น พื้นที่จัดเก็บในเบราว์เซอร์ใช้เพียงสองสิ่งที่จำเป็นต่อการทำงาน คือ การคงสถานะการเข้าสู่ระบบ และการจดจำว่าคุณเลือกภาษาอังกฤษหรือภาษาไทย',
