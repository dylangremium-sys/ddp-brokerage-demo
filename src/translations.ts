...
export const T = {
  en: {
    ...
    homeSupplyKicker: 'Real supply. Structured evidence.',
    homeSupplyTitle: 'From cultivation to a buyer-ready review',
    homeSupplyBody: 'DDP connects product imagery, farm records, batch evidence and laboratory documents in one controlled review process. Every commercial decision remains human-led.',
    homeSupplyProofLabel: 'Evidence handled by DDP',
    homeSupplyProof1: 'Original files retained',
    homeSupplyProof2: 'Batch associations reviewed',
    homeSupplyProof3: 'Buyer access controlled',
    homeSupplyImageFlowerAlt: 'Documented cannabis flower held in a gloved hand',
    homeSupplyImageCultivationAlt: 'Cannabis flower photographed during cultivation',
    homeSupplyImageBatchAlt: 'Cannabis flower samples photographed during batch documentation',
  ...
  th: {
    ...
    homeSkipToContent: 'ข้ามไปยังเนื้อหาหลัก',
    homeSupplyKicker: 'สินค้าจริง หลักฐานที่เป็นระบบ',
    homeSupplyTitle: 'จากการเพาะปลูกสู่การตรวจสอบสำหรับผู้ซื้อ',
    homeSupplyBody: 'DDP เชื่อมโยงภาพสินค้า ข้อมูลฟาร์ม หลักฐานแบตช์ และเอกสารห้องปฏิบัติการไว้ในกระบวนการตรวจสอบที่มีการควบคุม โดยการตัดสินใจทางการค้าทุกขั้นตอนยังคงดำเนินการโดยบุคคล',
    homeSupplyProofLabel: 'การจัดการหลักฐานโดย DDP',
    homeSupplyProof1: 'เก็บรักษาไฟล์ต้นฉบับ',
    homeSupplyProof2: 'ตรวจสอบการเชื่อมโยงกับแบตช์',
    homeSupplyProof3: 'ควบคุมการเข้าถึงของผู้ซื้อ',
    homeSupplyImageFlowerAlt: 'ดอกกัญชาที่มีการบันทึกข้อมูลอยู่บนมือที่สวมถุงมือ',
    homeSupplyImageCultivationAlt: 'ดอกกัญชาที่ถ่ายภาพระหว่างการเพาะปลูก',
    homeSupplyImageBatchAlt: 'ตัวอย่างดอกกัญชาที่ถ่ายภาพระหว่างการบันทึกข้อมูลแบตช์',
