...
export const T = {
  en: {
    ...
    corpAboutReviewNote: 'Every review ends with a person, not a score. The platform organises evidence and shows what is present, what is outstanding and what is still under review — the decision to progress a batch is made by a reviewer and recorded against that batch.',
    ...
    corpPrivacyCookiesText: 'This site runs no third-party analytics, advertising or tracking scripts. Its content security policy permits the browser to load code only from this site itself, and to send data only to our own backend.',
    corpPrivacyFontsText: 'It does load its typefaces from Google Fonts, so Google receives your IP address and basic request information when a page loads. Nothing else about you is shared with them, and no other outside service is contacted.',
  ...
  th: {
    ...
    corpAboutReviewNote: 'การตรวจทานทุกครั้งจบลงด้วยการตัดสินใจของบุคคล ไม่ใช่คะแนนอัตโนมัติ ระบบจะจัดระเบียบหลักฐานและแสดงว่ามีเอกสารใดครบ ใดยังขาด และใดอยู่ระหว่างการตรวจสอบ ส่วนการตัดสินใจว่าจะดำเนินการกับล็อตสินค้าต่อหรือไม่นั้นทำโดยผู้ตรวจทานและถูกบันทึกไว้กับล็อตนั้น',
    ...
    corpPrivacyCookiesText: 'เว็บไซต์นี้ไม่ใช้สคริปต์วิเคราะห์ข้อมูล โฆษณา หรือการติดตามจากบุคคลที่สาม นโยบายความปลอดภัยของเนื้อหาอนุญาตให้เบราว์เซอร์โหลดโค้ดจากเว็บไซต์นี้เท่านั้น และส่งข้อมูลไปยังระบบหลังบ้านของเราเท่านั้น',
    corpPrivacyFontsText: 'อย่างไรก็ตาม เว็บไซต์โหลดแบบอักษรจาก Google Fonts ดังนั้น Google จะได้รับที่อยู่ไอพีและข้อมูลพื้นฐานของคำขอเมื่อคุณเปิดหน้าเว็บ ทั้งนี้ไม่มีข้อมูลอื่นใดเกี่ยวกับคุณถูกเปิดเผยแก่ Google และไม่มีการติดต่อบริการภายนอกอื่นใด',
