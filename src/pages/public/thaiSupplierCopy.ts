...
export const NEEDS_NATIVE_REVIEW = [
  { key: 'headingDocuments', en: 'Documents we need from you', th: 'เอกสารที่เราต้องการจากคุณ' },
  ...
  {
    key: 'docLicence',
    en: 'A current Thai licence, valid at the time of supply',
    th: 'ใบอนุญาตไทยที่ยังมีผลบังคับใช้ ณ เวลาที่จัดหา',
  },
  {
    key: 'docCoa',
...
export const PENDING_SECTIONS = [
  {
    section: 'What DDP buys — product forms',
    why: 'The brief names the topic but no form list exists in any language. Naming forms is a statement about what the company will and will not take.',
  },
  {
    section: 'What DDP buys — specification',
    why: 'No specification has been published in English. A specification a supplier could be held to is a commercial commitment, not a description.',
  },
  {
    section: 'What DDP buys — volume',
    why: 'No volumes given. A stated minimum or maximum is a commitment and would be read as one.',
  },
  {
    section: 'GACP expectation',
    why: 'GACP appears in this repo only as an internal upload field label, never as published prose. Stating it as an expectation is a new requirement on suppliers.',
  },
  {
    section: 'Timeline after applying',
    why: 'The brief asks for a rough timeline; none was given, and an invented one is a promise. The existing review note says what happens, without saying when.',
  },
] as const
