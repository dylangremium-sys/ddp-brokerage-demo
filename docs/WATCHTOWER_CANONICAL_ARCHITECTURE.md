...
- **Enforcement — NOT BUILT.** Tracked as W8 (35 points) in `docs/MASTER_PLAN.md:65,298-303`.
...
| Review UI | `complianceRules.ts` | `src/lib/complianceRules.ts` | Status/severity/entity vocabularies; `isEnforcedRuleStatus`; 14 baseline rules, all `suggested` |
