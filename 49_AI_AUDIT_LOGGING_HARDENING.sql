...
REVOKE EXECUTE ON FUNCTION ai_create_audit_event(UUID, TEXT, UUID, JSONB, BOOLEAN) FROM PUBLIC;
REVOKE EXECUTE ON FUNCTION ai_create_audit_event(UUID, TEXT, UUID, JSONB, BOOLEAN) FROM anon;
