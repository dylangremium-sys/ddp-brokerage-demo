...
CREATE INDEX idx_ai_prompts_feature ON ai_prompts(feature_code);
...
CREATE INDEX idx_ai_prompt_versions_version ON ai_prompt_versions(version_number);
...
CREATE INDEX idx_ai_model_configs_feature ON ai_model_configs(feature_code);
...
CREATE INDEX idx_ai_prompt_experiments_prompt_id ON ai_prompt_experiments(prompt_id);
CREATE INDEX idx_ai_prompt_experiments_dates ON ai_prompt_experiments(experiment_start_date, experiment_end_date);
...
REVOKE EXECUTE ON FUNCTION get_model_config(TEXT, TEXT) FROM PUBLIC;
REVOKE EXECUTE ON FUNCTION get_model_config(TEXT, TEXT) FROM anon;
